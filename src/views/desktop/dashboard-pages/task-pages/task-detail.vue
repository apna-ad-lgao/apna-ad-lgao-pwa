<template>
  <section class="dashboard-task-feedback-page bg-white h-min-screen">
    ...
    <div v-else>
      ...
      <h1 class="letter-spacing-05 md:text-2xl font-bold mb-4 mx-5">
      ...
      <section class="salutation-cont my-6 mx-6">
        ...
        <h1 class="letter-spacing-05 md:text-2xl mt-10 flex justify-between font-bold items-center">
          <span>
            Historical data
            <p v-if="noFeedbacksForToday" class="md:text-lg font-normal text-yellow-600">
        ...
        <section class="mt-2">
          ...
          >
            ...
            <div class="flex-2 text-left">
              <p v-for="(keyword, i) in feedback.keywords" :key="keyword" class="inline-block rounded-lg">
