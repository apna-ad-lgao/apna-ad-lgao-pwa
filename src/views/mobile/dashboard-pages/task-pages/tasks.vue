  ...
  <section class="dashboard-tasks-page bg-white h-min-screen mt-12 p-5 px-6 pt-2" @scroll="handleScroll">
    ...
    <section v-show="companies && companies.length" class="content-cont my-6 pb-1">
      <div
        ...
        :class="[ company.feedback ? 'border border-green-400 bg-green-100' : 'shadow' ]"
        class="
          task-item
          w-full
          focus:outline-none
      ...
      >
        ...
        <div>
          <i v-if="company.feedback" class="fa-check text-green-400 fas relative text-lg" />
          <i v-else class="fa-ellipsis-h fas relative text-gray-500" style="top: -1px;" />
